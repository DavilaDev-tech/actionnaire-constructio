...
<script>
    (function () {
        ...
        input.addEventListener('input', function () {
            ...
            // Délai 300ms pour ne pas surcharger
            timer = setTimeout(() => {
...
<script>
    (function () {
        ...
        const vide = document.getElementById('notif-vide');

        if (!badge || !liste) return;

        const icones = {
            'Alerte stock bas': 'bi-exclamation-triangle text-warning',
        };
            ...
            fetch('/notifications/non-lues', {
                ...
                .then(data => {
                    ...
                    if (data.count > 0) {
                        ...
                        // Animer la cloche
                        document.getElementById('btn-cloche')
                            .classList.add('cloche-anim');
                        setTimeout(() => {
                            document.getElementById('btn-cloche')
                                .classList.remove('cloche-anim');
                        }, 1000);
                    } else {
...
<body>
    ...
    <nav id="sidebar">
        ...
        <div class="py-2">
            ...
            <!-- Ventes (admin + vendeur voient tout, magasinier voit produits) -->
            ...
            <!-- Comptable voit factures et paiements -->
            ...
            @endif
            <!-- Vendeur voit aussi livraisons en lecture -->
        ...
        <div class="mt-auto p-3 border-top border-white border-opacity-10">
            <form method="POST" action="{{ route('logout') }}">
                ...
                <button type="submit" class="btn btn-sm w-100 text-start d-flex align-items-center gap-2" style="color:rgba(255,255,255,0.6);background:none;border:none;
                           padding:8px 12px;border-radius:6px;" onmouseover="this.style.background='rgba(255,255,255,0.08)';
                                 this.style.color='white'" onmouseout="this.style.background='none';
    ...
    <div id="topbar">
        ...
        <form action="{{ route('recherche') }}" method="GET" style="position:relative;width:360px" id="form-recherche">
            <div class="input-group">
                ...
                <button type="submit" class="btn text-white" style="background:#1a3c5e;
            ...
            <div class="dropdown" id="notif-dropdown">
                <button class="btn position-relative p-2 border-0" data-bs-toggle="dropdown" id="btn-cloche"
                    ...
                    <span id="notif-badge" class="position-absolute top-0 start-100 translate-middle
                     badge rounded-pill bg-danger" style="display:none;font-size:0.65rem">
                        0
                    </span>
                </button>
