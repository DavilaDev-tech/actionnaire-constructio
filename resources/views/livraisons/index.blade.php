...
<style>
    ...
    .statut-livree {
        background: #F0FDF4; color: #10B981; border: 1px solid #A7F3D0;
    }
    .select-statut {
        border: 1px solid #E5E7EB;
        border-radius: 8px;
...
<div class="d-flex justify-content-between align-items-start mb-5">
    <div>
        ...
        <p style="color:#9CA3AF;font-size:0.875rem;margin:0">
            {{ $totalLivraisons }} livraison{{ $totalLivraisons > 1 ? 's' : '' }} enregistrée{{ $totalLivraisons > 1 ? 's' : '' }}
        </p>
    </div>
    <div class="d-flex gap-2">
        <a href="{{ route('livraisons.carte') }}"
           ...
           style="background:white;border:1px solid #E5E7EB;color:#374151;
            ...
            <i class="bi bi-map me-1" style="color:#3B82F6"></i>
            Voir la carte
        </a>
        <a href="{{ route('livraisons.create') }}"
           ...
           style="background:linear-gradient(135deg,#F97316,#EA580C);
            ...
            <i class="bi bi-plus me-1"></i> Nouvelle livraison
        </a>
    </div>
</div>
...
<div class="row g-3 mb-5">
    <div class="col-md-3">
        <div class="hector-stat">
            ...
            <div>
                <div class="hector-stat-value">{{ $totalLivraisons }}</div>
    ...
    <div class="col-md-3">
        <div class="hector-stat">
            ...
            <div>
                <div class="hector-stat-value">{{ $enCours }}</div>
                <div class="hector-stat-label">En cours</div>
            </div>
            <div class="ms-auto">
                <span style="font-size:0.72rem;color:#3B82F6;font-weight:600;
    ...
    <div class="col-md-3">
        <div class="hector-stat">
            ...
            <div>
                <div class="hector-stat-value">{{ $livrees }}</div>
...
<div class="card" style="border:1px solid #F3F4F6;border-radius:12px;
    ...
    <div class="d-flex justify-content-between align-items-center px-4 py-3"
        ...
        <div class="search-wrapper">
            ...
            <input type="text"
                   class="search-input"
                   id="recherche-livraisons"
                   placeholder="Rechercher une livraison...">
        </div>
        <div class="d-flex align-items-center gap-3">
            <select id="filtre-statut-livraison"
            ...
            <span style="font-size:0.8rem;color:#9CA3AF">
                ...
                résultat{{ $livraisons->total() > 1 ? 's' : '' }}
            </span>
        </div>
    </div>

    {{-- Table --}}
    <div id="tableau-livraisons" class="table-responsive">
        @include('livraisons.partials.tableau')
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    const input  = document.getElementById('recherche-livraisons');
    const filtre = document.getElementById('filtre-statut-livraison');
    const tbody  = document.querySelector('#tableau-livraisons tbody');
